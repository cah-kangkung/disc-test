...
<section>
    <div class="container">
        <div class="row">
                                        ...
                                        <div class="form-group question">
                                            <p class="card-text">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="option<?php echo $i ?>Influence" name="question<?php echo $i; ?>" class="custom-control-input" checked>
                                                    <label class="custom-control-label" for="option<?php echo $i ?>Influence"><?php echo $question['influence'] ?></label>
                                                </div>
                                            </p>
                                            <p class="card-text">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="option<?php echo $i ?>Dominant" name="question<?php echo $i; ?>" class="custom-control-input">
                                                    <label class="custom-control-label" for="option<?php echo $i ?>Dominance"><?php echo $question['dominance'] ?></label>
                                                </div>
                                            </p>
                                            <p class="card-text">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="option<?php echo $i ?>Correct" name="question<?php echo $i; ?>" class="custom-control-input">
                                                    <label class="custom-control-label" for="option<?php echo $i ?>Compliance"><?php echo $question['compliance'] ?></label>
                                                </div>
                                            </p>
                                            <p class="card-text">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="option<?php echo $i ?>Stable" name="question<?php echo $i; ?>" class="custom-control-input">
            ...
            <div class="col-lg-2">
                <div class="card card-timer text-white bg-warning mb-3" style="max-width: 20rem;">
                    <div class="card-body align-center">
                        <p class="card-text">Test sedang berjalan</p>
                        <p class="card-text mb-0">Sisa Waktu:</p>
                        <p class="card-text test-timer">12 : 01</p>
                    </div>
                </div>
            </div>
        </div>
